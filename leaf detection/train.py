...
def main():
    ...
    try:
        model = YOLO("yolo11n.pt")  # Use nano version for less memory usage
    ...
    # Train with reduced settings to prevent OOM
    results = model.train(
        data="C:\\Users\\amber\\OneDrive\\Documents\\GitHub\\Monash--AI\\leaf detection\\data.yaml", 
